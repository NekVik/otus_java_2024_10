...
import ru.otus.webserver.web.servlet.ClientsAddServlet;
import ru.otus.webserver.web.servlet.ClientsApiServlet;
import ru.otus.webserver.web.servlet.ClientsServlet;
...
public class ClientsWebServerSimple implements ClientsWebServer {
    ...
    private void initContext() {
        ...
        sequence.addHandler(applySecurity(servletContextHandler, "/clients", "/clients/add", "/api/user/*"));
